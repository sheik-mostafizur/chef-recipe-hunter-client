...
const Footer = () => {
  return (
    <div className="w-full pt-12 flex items-center justify-center bg-[#d5421525]">
      <div className="md:w-2/3 w-full px-4 flex flex-col">
        <div className="w-full text-4xl md:text-7xl font-bold">
          <h1 className="w-full md:w-2/3 text-primary">
            How can we help you. get in touch
          </h1>
        </div>
        <div className="flex mt-8 flex-col md:flex-row md:justify-between">
          <p className="w-full md:w-2/3">
            Recipe Master is an online recipe platform that offers a wide range
            of recipes from around the world. With easy-to-follow instructions
            and helpful tips, you can create delicious meals for any occasion.
            Whether you{`'`}re an experienced chef or a beginner, Recipe Master
            has something for everyone.
          </p>
          <div className="md:w-44 pt-6 md:pt-0">
            <button className="btn-primary md:text-3xl block w-32 md:w-52">
              Contact US
            </button>
          </div>
        </div>
